import { formatTime, formatDate } from "@/constant/date-time-format/DateTimeFormat";
        ...
        <div className="flex items-center gap-4 p-4 sm:flex-wrap">
          ...
          <div className="w-[80%] sm:w-[100%]">
            ...
            <div className="description flex gap-2 items-center sm:flex-wrap">
              <p className="text-sm text-black">{formatDate(item?.bookingDate) ? formatDate(item?.bookingDate) : ""} </p>
