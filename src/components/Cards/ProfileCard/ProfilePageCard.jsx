...
const ProfilePageCard = ({ active, icon, text,link }) => {
  return (
   <Link to={link}> <div className={`profileShadow flex mb-2 gap-4 rounded-md  justify-between items-center border  p-4 cursor-pointer ${active ? "text-white bg-backgroundFill-900" : "text-backgroundFill-900 "}`}>
      <div className="">
