...
const FreezeAccountModal = ({ freezeAccountModalState, setFreezeAccountModalState }) => {
      ...
      <div ref={modalRef} className="bg-white rounded-t-2xl px-7 shadow-lg w-full max-w-4xl xl:max-w-2xl lg:max-w-full p-3">
        ...
        <div className="flex justify-center mt-7">
          <div className="rounded-full p-6 bg-[#ffebec] md:p-4">
            <img src={Images.slash} alt="slash" className="md:w-10 md:h-10 w-[60px] h-[60px]" />
          </div>
        </div>
        ...
        <div className="flex mt-4 gap-2">
          <button onClick={setFreezeAccountModalState} className="border border-grey-900 text-grey-900 py-3 font-bold rounded md:text-sm w-[49%]">
            Cancel
          </button>
          <button onClick={setFreezeAccountModalState} className="bg-grey-900 text-white py-3 font-bold rounded md:text-sm w-[49%]">
            Send Request
          </button>
        </div>
      </div>
