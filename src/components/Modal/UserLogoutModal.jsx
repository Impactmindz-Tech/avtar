      ...
      <div ref={modalRef} className="bg-white rounded-t-2xl px-7 shadow-lg w-full max-w-4xl xl:max-w-2xl lg:max-w-full p-3">
        ...
        <div className="flex justify-center mt-7">
          <div className="rounded-full p-6 bg-[#ffebec] md:p-4">
            <img src={Images.logout} alt="slash" className="md:w-10 md:h-10 w-[60px] h-[60px]" />
          </div>
        </div>
        <div className="flex justify-center py-5">
          <p className="text-grey-800">Are you sure you would like to log out of your Avatar Walk account?</p>
        </div>
