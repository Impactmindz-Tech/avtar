...
const MultipleAddressModal = ({ multipleAddressModalState, setMultipleAddressModalState }) => {
        ...
        <div className="p-4">
          <div className="mb-4">
            <div className="flex items-start">
              <div className="pt-1">
                <input type="radio" name="location" id="location1" className="form-radio h-5 w-5 mr-4" />
              </div>
            ...
            <div className="flex items-start">
              <div className="pt-1">
                <input type="radio" name="location" id="location2" className="form-radio h-5 w-5 mr-4" />
              </div>
              <div className="flex justify-between  items-center mb-2 w-full">
                <div className="flex-1">
            ...
            <div className="flex items-start">
              <div className="pt-1">
                <input type="radio" name="location" id="location3" className="form-radio h-5 w-5 mr-4" />
              </div>
              <div className="flex justify-between  items-center mb-2 w-full">
                <div className="flex-1">
          ...
          <div className="flex gap-2 items-center">
            ...
            <h3 className="font-medium text-gray-700 cursor-pointer">Use current location</h3>
          </div>
        </div>

        <h3 className="text-center underline underline-offset-2 font-semibold cursor-pointer">Add a new address</h3>
        <div className="flex mt-4">
          <button onClick={setMultipleAddressModalState} className="bg-black text-white py-3 rounded w-full">
            Save
          </button>
        </div>
      </div>
