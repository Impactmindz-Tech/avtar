      ...
      <div className="BoxShadowLessRounded pb-2">
        <div className="flex  gap-4 p-4 sm:flex-wrap">
          <div className="sm:w-[100%] relative">
            ...
            <div className="absolute bottom-3 right-1 px-2 rounded-full font-bold bg-white">${item?.totalPrice}</div>
          </div>
          <div className="w-[80%] sm:w-[100%]">
            ...
            <div className="flex  items-center gap-2">
              ...
              <div className="flex-1">{formatTime(item?.bookingTime)} - {formatTime(item?.endTime)}</div>
            </div>
          </div>
        </div>
        <div className="flex justify-between m-auto w-[94%] py-2 text-grey-800">
          <button className="border border-primaryColor-900 text-black font-semibold py-2 rounded mr-2 w-[50%]">Cancel</button>
