...
function AvatarHeader() {
  ...
  return (
    <>
      {/* {loading && <Loader />} */}
      {(location.pathname == "/avatar/offers"||location.pathname == "/avatar/chatwithuser"||location.pathname == "/avatar/bank"||location.pathname == "/avatar/stripe"||location.pathname == "/avatar/account-info") ? <>
