...
function AvatarHeader() {
  ...
  return (
    <>
      {/* {loading && <Loader />} */}
      {(location.pathname == "/avatar/offers"||location.pathname == "/avatar/instant-cash"||location.pathname == "/avatar/add-experience-image"||location.pathname == "/avatar/edit-experience"||location.pathname == "/avatar/add-new-experience"||location.pathname == "/avatar/add-experience"||location.pathname == "/avatar/chatwithuser"||location.pathname == "/avatar/bank"||location.pathname == "/avatar/stripe"||location.pathname == "/avatar/account-info") ? <>
