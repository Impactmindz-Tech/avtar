  ...
  return (
    <div className="container">
      ...
      <div className="flex items-center justify-between gap-5 my-5">
        ...
        <div className="flex-1 font-bold text-lg text-grey-900">
          Visa...3498
        </div>

        <div className="font-bold underline underline-offset-4 cursor-pointer">
          Edit
        </div>
      </div>
      <Link to={"/"}>
        ...
        <div className="absolute bottom-1 left-0  w-full ">
          <div className="w-full flex justify-center">
            <button className="font-bold lg:w-[90%] p-3 bg-backgroundFill-900 rounded-md text-white w-[78%]">
              Cash Out $230.40
            </button>
          </div>
        </div>
