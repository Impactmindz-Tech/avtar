    ...
    <>
      ...
      <div className="container">
        ...
        <button className="border hover:bg-[#FF7070] hover:text-white font-bold border-borderFill-400 text-borderFill-400 w-full p-2 text-lg rounded-lg">Instant Live</button> */}
          ...
          <div onClick={isFormComplete ? onSubmit : null} className={`w-full my-6 rounded-md bottom-1 m-auto left-0 right-0 p-2 cursor-pointer bg-backgroundFill-900 text-white text-center ${!isFormComplete ? "opacity-[0.5]" : "opacity-1"}`}>
            <button disabled={!isFormComplete} className="py-1 font-bold ">{"Book"}</button>
          </div>
