    ...
    <div className="container">
      ...
      <div className="tour">
        <div className="flex justify-between items-center">
          <h1 className="text-grey-900">Jane Copper Tours</h1>
          <h1 className="text-grey-800 underline underline-offset-4 cursor-pointer">Show All</h1>
        </div>
        <div className="my-6">
        ...
        <div className="BoxShadow border-grey-800 cursor-pointer" onClick={()=>setMultipleAddressModalState(true)}>
