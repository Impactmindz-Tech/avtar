...
const emailValidation = yup
  ...
  const checkboxValidation = yup.boolean()
  ...
  export const registrationValidation = yup.object({
    ...
    confirmPassword: yup.string()
      ...
      terms: yup.boolean()
      .oneOf([true], 'You must agree to the Privacy Policy and Terms of Services')
      .required('You must agree to the Privacy Policy and Terms of Services'),
  });
